...
import pytest
from utils import is_palindrome, fibonacci, count_vowels, calculate_discount, flatten_list, word_frequencies, is_prime
...
def test_is_prime():
    ...
    assert is_prime(97)
    assert not is_prime(5) is False  # 5 is prime, so should be True
